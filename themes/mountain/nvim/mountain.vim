...
call <sid>hi("MatchParen",    s:gui0C, s:gui00, "", s:cterm03,  "bold", "")
...
call <sid>hi("WildMenu",      s:gui0A, s:gui01, s:cterm08, "", "", "")
...
call <sid>hi("VertSplit",     s:gui00, s:gui00, s:cterm02, s:cterm02, "none", "")
...
call <sid>hi("TabLine",       s:gui0A, s:gui00, s:cterm03, s:cterm01, "none", "")
